  ...
  const steps = [
    {
      ...
      description: "Share your health goals, dietary preferences, and lifestyle. Our smart algorithm creates a personalized meal plan just for you.",
      features: [
    ...
    },
    {
      ...
      description: "Enjoy your meals, track your progress, and watch the transformation happen. Our nutrition team is always available to support your journey.",
      features: [
  ...
  const benefits = [
    {
      ...
      description: "Every meal plan is customized based on your specific goals, preferences, and dietary requirements."
    },
    {
      icon: "👨‍🍳",
      title: "Chef-Prepared Meals",
      description: "Our expert Indian chefs prepare every meal using traditional techniques and the finest ingredients."
    },
    {
      icon: "📱",
      title: "Easy to Track",
      description: "Monitor your progress with our intuitive app and get insights into your health journey."
    },
    {
      icon: "🚀",
      title: "Proven Results",
      description: "Join thousands who've successfully achieved their weight loss goals with SpiceBox."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From personalized meal planning to doorstep delivery, we've made healthy eating simple, 
              delicious, and authentically Indian.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're not just another meal delivery service. We're your partners in achieving sustainable weight loss with authentic Indian flavors.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-orange-100 mb-8">
              Join thousands of satisfied customers who've transformed their health with SpiceBox
            </p>
